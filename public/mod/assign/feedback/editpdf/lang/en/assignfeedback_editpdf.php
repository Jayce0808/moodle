...
$string['errorgsfailed'] = 'Ghostscript failed while processing "{$a->file}".';
...
$string['gstimeout_desc'] = 'Maximum time to allow Ghostscript to run per invocation. Set to 0 to disable the timeout.';
