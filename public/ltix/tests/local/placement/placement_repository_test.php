...
final class placement_repository_test extends \advanced_testcase {
    ...
    public function test_is_placement_enabled_for_tool_in_course(array $toolsettings, array $placementsettings,
        ...
        $placementtype = $ltigenerator->create_placement_type('core_ltix', 'core_ltix:validplacement');
    ...
    public function test_get_tools_with_enabled_placement_in_course(
        ...
        // Create placements for each type.
    ...
    public static function get_placement_overrides_provider(): array {
        return [
            'Default YES, Override NULL' => [
                'toolcoursevisible' => \core_ltix\constants::LTI_COURSEVISIBLE_PRECONFIGURED,
                'toolstate' => \core_ltix\constants::LTI_TOOL_STATE_CONFIGURED,
            ...
            'Tool is hidden' => [
                'toolcoursevisible' => \core_ltix\constants::LTI_COURSEVISIBLE_NO,
                'toolstate' => \core_ltix\constants::LTI_TOOL_STATE_CONFIGURED,
                'placementdefault' => 'enabled',
                'placementoverride' => null,
                'expectedcount' => 0,
            ...
            'Tool is pending' => [
                'toolcoursevisible' => \core_ltix\constants::LTI_COURSEVISIBLE_PRECONFIGURED,
                'toolstate' => \core_ltix\constants::LTI_TOOL_STATE_PENDING,
                'placementdefault' => 'enabled',
                'placementoverride' => null,
                'expectedcount' => 0,
            ],
