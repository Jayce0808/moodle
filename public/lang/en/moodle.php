...
$string['deletecheckfull'] = '<p>This action will remove data such as profile information, enrolments, group and cohort memberships, and certain user activity records.</p>';
