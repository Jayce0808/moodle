...
class text_filter extends \core_filters\text_filter {
    ...
    public function filterobject_prepare_replacement_callback($concept, $glossaries) {
        ...
        if ($concept->category) { // Link to a category.
            ...
            $title = get_string(
                'glossaryconcept',
                'filter_glossary',
                ['glossary' => replace_ampersands_not_followed_by_entity(strip_tags($this->glossary_format_string($glossaries[$concept->glossaryid]))),
    ...
    private function glossary_format_string(string $text): string {
        ...
        try {
            // Temporarily disable the glossary filter.
